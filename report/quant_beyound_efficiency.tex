...
Adversarial examples for images can be approximated by gradient decent, because the model is end-to-end differentiable from input to output. 
This trick does not work for LLMs because the step from token IDs to embeddings is a discrete operation.
